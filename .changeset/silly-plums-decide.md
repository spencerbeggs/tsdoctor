...
* `fetchGitHubReleaseBundle` — fetch a bundle from GitHub release assets (including the `*.npm.meta.tgz` release variant), with results cached under the shared XDG `"tsdoctor"` cache namespace
