...
| @tsdoctor/model | dependency | updated | 0.8.1 | 0.8.2 |
| @tsdoctor/pages | dependency | updated | 0.3.1 | 0.3.2 |
...
[#290]: https://github.com/spencerbeggs/tsdoctor/pull/290
...
| @tsdoctor/bundle | dependency | updated | 0.4.5 | 0.5.0 |
| @tsdoctor/model | dependency | updated | 0.7.4 | 0.8.1 |
| @tsdoctor/pages | dependency | updated | 0.2.5 | 0.3.1 |
| @tsdoctor/registry | dependency | updated | 0.4.4 | 0.5.1 |
| @tsdoctor/seo | dependency | updated | 0.3.3 | 0.4.0 |
| @tsdoctor/snapshot | dependency | updated | 0.3.3 | 0.4.0 |
| @tsdoctor/vfs | dependency | updated | 0.3.4 | 0.4.0 |
| @typescript/vfs | dependency | updated | ^1.6.4 | ^1.6.5 |
...
| @tsdoctor/pages | dependency | updated | 0.2.5 | 0.3.0 |
| @tsdoctor/registry | dependency | updated | 0.4.4 | 0.5.0 |
| @tsdoctor/seo | dependency | updated | 0.3.3 | 0.4.0 |
| @tsdoctor/snapshot | dependency | updated | 0.3.3 | 0.4.0 |
| @tsdoctor/vfs | dependency | updated | 0.3.4 | 0.4.0 |
...
| @tsdoctor/bundle | dependency | updated | 0.4.4 | 0.4.5 |
| @tsdoctor/manifest | dependency | updated | 0.2.1 | 0.2.2 |
| @tsdoctor/model | dependency | updated | 0.7.3 | 0.7.4 |
| @tsdoctor/pages | dependency | updated | 0.2.4 | 0.2.5 |
| @tsdoctor/registry | dependency | updated | 0.4.3 | 0.4.4 |
| @tsdoctor/seo | dependency | updated | 0.3.2 | 0.3.3 |
| @tsdoctor/snapshot | dependency | updated | 0.3.2 | 0.3.3 |
...
| @tsdoctor/bundle | dependency | updated | 0.4.3 | 0.4.4 |
| @tsdoctor/model | dependency | updated | 0.7.2 | 0.7.3 |
| @tsdoctor/pages | dependency | updated | 0.2.3 | 0.2.4 |
| @tsdoctor/registry | dependency | updated | 0.4.2 | 0.4.3 |
...
| @tsdoctor/bundle | dependency | updated | 0.4.2 | 0.4.3 |
| @tsdoctor/manifest | dependency | updated | 0.2.0 | 0.2.1 |
| @tsdoctor/model | dependency | updated | 0.7.1 | 0.7.2 |
| @tsdoctor/pages | dependency | updated | 0.2.2 | 0.2.3 |
| @tsdoctor/registry | dependency | updated | 0.4.1 | 0.4.2 |
| @tsdoctor/seo | dependency | updated | 0.3.1 | 0.3.2 |
| @tsdoctor/snapshot | dependency | updated | 0.3.1 | 0.3.2 |
| @tsdoctor/vfs | dependency | updated | 0.3.1 | 0.3.2 |
...
| @tsdoctor/bundle | dependency | updated | 0.4.0 | 0.4.1 |
| @tsdoctor/model | dependency | updated | 0.7.0 | 0.7.1 |
| @tsdoctor/pages | dependency | updated | 0.2.0 | 0.2.1 |
| @tsdoctor/registry | dependency | updated | 0.4.0 | 0.4.1 |
| @tsdoctor/seo | dependency | updated | 0.3.0 | 0.3.1 |
| @tsdoctor/snapshot | dependency | updated | 0.3.0 | 0.3.1 |
| @tsdoctor/vfs | dependency | updated | 0.3.0 | 0.3.1 |
...
[#264]: https://github.com/spencerbeggs/tsdoctor/pull/264
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @tsdoctor/model | dependency | updated | 0.6.6 | 0.6.7 |
| @tsdoctor/pages | dependency | updated | 0.1.7 | 0.1.8 |
| prettier | dependency | updated | ^3.9.6 | ^3.9.7 |
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| image-size | dependency | updated | ^2.0.3 | ^2.0.4 |
...
[#251]: https://github.com/spencerbeggs/tsdoctor/pull/251
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| image-size | dependency | updated | ^2.0.2 | ^2.0.3 |
...
[#249]: https://github.com/spencerbeggs/tsdoctor/pull/249
...
| @tsdoctor/bundle | dependency | updated | 0.3.4 | 0.3.5 |
| @tsdoctor/registry | dependency | updated | 0.3.6 | 0.3.7 |
...
[#246]: https://github.com/spencerbeggs/tsdoctor/pull/246
...
| Dependency | Type | Action | From | To |
| --- | --- | --- | --- | --- |
| @effected/github | dependency | updated | ^0.10.0 | ^0.10.1 |
| @tsdoctor/bundle | dependency | updated | 0.3.3 | 0.3.4 |
...
[#239]: https://github.com/spencerbeggs/tsdoctor/pull/239
...
| @tsdoctor/bundle | dependency | updated | 0.3.1 | 0.3.2 |
| @tsdoctor/model | dependency | updated | 0.6.3 | 0.6.4 |
| @tsdoctor/pages | dependency | updated | 0.1.4 | 0.1.5 |
| @tsdoctor/registry | dependency | updated | 0.3.4 | 0.3.5 |
| @tsdoctor/vfs | dependency | updated | 0.2.2 | 0.2.3 |
...
| @tsdoctor/pages | dependency | updated | 0.1.2 | 0.1.3 |
| @tsdoctor/registry | dependency | updated | 0.3.2 | 0.3.3 |
...
| @tsdoctor/snapshot | dependency | updated | 0.2.3 | 0.2.4 |
...
| @tsdoctor/bundle | dependency | updated | 0.2.1 | 0.2.2 |
