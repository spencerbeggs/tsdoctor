...
* [Keep the RSPress adapter's dependency closure whole](rspress-dependency-closure.md) - Keep the full non-optional peer closure of the RSPress adapter in dependencies, not peerDependencies; never prune an entry as unused without checking.
